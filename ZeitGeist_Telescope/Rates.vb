...
'
' The Guid attribute sets the CLSID for ASCOM.ASCOM.ZeitGeist.eq5.Telescope.Rate
' The ClassInterface/None addribute prevents an empty interface called
' _Rate from being created and used as the [default] interface
'
<Guid("5ac53ec0-a5ac-4b93-8f4e-6679c396a3a5")> _
...
' this polymorphism. 
'
' The Guid attribute sets the CLSID for ASCOM.ASCOM.ZeitGeist.eq5.Telescope.AxisRates
' The ClassInterface/None addribute prevents an empty interface called
' _AxisRates from being created and used as the [default] interface
'
<Guid("948d2c40-e3bc-4524-9c7d-6955e7c08e7e")> _
<ClassInterface(ClassInterfaceType.None)> _
<ComVisible(True)> _
...
' this polymorphism. 
'
' The Guid attribute sets the CLSID for ASCOM.ASCOM.ZeitGeist.eq5.Telescope.TrackingRates
' The ClassInterface/None addribute prevents an empty interface called
' _TrackingRates from being created and used as the [default] interface
'
<Guid("c0836d59-d928-4208-8365-0bd114911285")> _
<ClassInterface(ClassInterfaceType.None)> _
<ComVisible(True)> _
